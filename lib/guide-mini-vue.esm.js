...
function provide(key, value) {
    ...
    if (currentInstance) {
        var provides_1 = currentInstance.provides;
        provides_1[key] = value;
    }
}
...
export { createApp, createRenderer, createTextVNode, getCurrentInstance, h, inject, provide, renderSolts };
