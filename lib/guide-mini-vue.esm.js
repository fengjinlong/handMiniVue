...
function provide(key, value) {
    ...
    var parentProvides = currentInstance.parent.providers;
    if (providers === parentProvides) {
        providers = currentInstance.providers = Object.create(parentProvides);
    }
    if (currentInstance) {
        var providers_1 = currentInstance.providers;
        providers_1[key] = value;
    }
}
...
export { createApp, createTextVNode, getCurrentInstance, h, inject, provide, renderSolts };
